...
const rootStyles = classNames(
  'bg-slate-50 flex items-center w-[500px] h-14 right-5 mr-6 reduce-motion'
);
const viewportStyles = classNames(
  'fixed bottom-0 right-0 flex flex-col p-[25px] gap-[10] max-w-[100vw] m-0 list-none z-50 outline-none'
);
...
const ToastAlert = (props: ToastAlertProps) => {
  ...
  return (
    <ToastPrimitive.Provider swipeDirection="right">
      ...
      >
        <div
          className={`flex h-full pl-4 items-center relative w-full ${
            variant == 'error'
              ? 'bg-[#FFEFED]'
              : variant == 'alert'
              ? 'bg-[#FFFAF0]'
